...
ki2 = LINETCR.LINE() 
ki2.login(token="EohFtFNq0RyB4iIi6Ji7.3TzydOH2+YOd12Ql7hHvfW.m1+8kgiXJA2MUvfx3o7RZJTuqmCXUFQmkMt71wWMwo0=")
ki2.loginResult()
...
admsa = "u2a3703b8141e2558921e35c1563c3576","ueacedbe88bf6e2c5cf6188b3a4a26e18"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u2a3703b8141e2558921e35c1563c3576":
                    if "join:" in msg.text:
